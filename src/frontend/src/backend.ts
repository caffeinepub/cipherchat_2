...
export class Backend implements backendInterface {
    ...
    async getConversation(arg0: UserId, arg1: UserId): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async getPublicKey(arg0: string): Promise<PublicKey | null> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: UserId, arg1: UserId, arg2: string, arg3: boolean): Promise<MessageId> {
        if (this.processError) {
            try {
    ...
    async storePublicKey(arg0: string, arg1: PublicKey): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Message]): Message | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PublicKey]): PublicKey | null {
    return value.length === 0 ? null : value[0];
}
